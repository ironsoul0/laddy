...
//     for (const problem of problems) {
//       // const currentProblem = await Problem.findOne(
//       //   {
//       //     where: { difficulty: problem.difficulty, name: problem.name },
//       //     relations: ["ladders"]
//       //   }
//       //   // { relations: ["ladders"] }
//       // );
//       // currentProblem?.ladders.push(ladder);
//       // await currentProblem?.save();
//       problemMap[problem.url].ladders.push(ladder);
//       await problemMap[problem.url].save();
//     }
//     // lads.push(ladder);
//   }

//   // for (const ladder of lads) {
//   //   await ladder.save();
//   // }
// };
